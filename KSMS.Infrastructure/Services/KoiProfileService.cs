...
public class KoiProfileService : BaseService<KoiProfileService>, IKoiProfileService
{
    ...
    public KoiProfileService(IUnitOfWork<KoiShowManagementSystemContext> unitOfWork, ILogger<KoiProfileService> logger, IFirebaseService firebaseService) : base(unitOfWork, logger)
    {
