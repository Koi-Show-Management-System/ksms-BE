...
namespace KSMS.Application.Services
{
    ...
    {
        Task<IEnumerable<GetAllKoiShowResponse>> GetAllShowsAsync(); 
        Task<GetAllKoiShowResponse> GetShowByIdAsync(Guid id);
        Task<GetAllKoiShowResponse> CreateShowAsync(CreateShowRequest request);
